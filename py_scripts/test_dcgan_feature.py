...
result_file = 'feature_norm_test.txt'
# result_file = 'feature_rgb_test.txt'

caffe.set_device(1)
caffe.set_mode_gpu()
net = caffe.Net('/nfs/hn46/xiaolonw/render_cnncode/caffe-render/py_scripts/dcgan_rgb/test_pool.prototxt',
                '/nfs.yoda/xiaolonw/fast_rcnn/models/dcgan_rgb/fast_rcnn_zero.caffemodel',
                caffe.TEST)
